...
If Hotspots are too close - less than 300 meters - they will not be eligible to witness each other as part of POC challenges and may compete with each other for challenges. Their overall participation in Proof-of-Coverage would be impacted also, since rewards are also density based.  Proof of coverage rewards good, wide coverage. You'll earn more HNT if you do this. 
